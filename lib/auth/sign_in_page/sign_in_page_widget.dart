                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SIGN_IN_PAGE_PAGE_Text_lq09u5hk_ON_TAP');
                            ...
                            Align(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'SIGN_IN_PAGE_PAGE_Text_3dk2k8lf_ON_TAP');
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'SIGN_IN_PAGE_PAGE_Row_ilan5eme_ON_TAP');
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                            ...
                            if (isiOS)
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SIGN_IN_PAGE_PAGE_Row_wdcw7gm2_ON_TAP');
                                  },
                                  child: Row(
                                    mainAxisSize: MainAxisSize.max,
